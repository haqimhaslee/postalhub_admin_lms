...
class ParcelInventoryOnDelivery extends StatefulWidget {
  const ParcelInventoryOnDelivery({super.key});
  @override
  State<ParcelInventoryOnDelivery> createState() =>
      _ParcelInventoryOnDeliveryState();
}

class _ParcelInventoryOnDeliveryState extends State<ParcelInventoryOnDelivery> {
  ...
  Future<void> _fetchMoreData() async {
    ...
    Query query = FirebaseFirestore.instance
        ...
        .where('status', isEqualTo: 2) // Filter by status
